...
# Begin setup
setup_keywords = dict()
setup_keywords['name'] = 'profiler'
setup_keywords['description'] = 'Tools for Profile Data in Oceanography'
setup_keywords['author'] = 'J. Xavier Prochaska et al.'
setup_keywords['author_email'] = 'jxp@ucsc.edu'
setup_keywords['license'] = 'BSD'
setup_keywords['url'] = 'https://github.com/Sea-Meets-the-Stars/profiler'
